...
def load_mnist(dir_name):
    ...
    def load_mnist_images(filename):
        ...
        # The inputs are vectors now, we reshape them to 2D arrays,
        # following the shape convention: (examples, features)
    ...
    data_path=os.path.join(script_dir,dir_name)
